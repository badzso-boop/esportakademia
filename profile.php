                        ...
                        <div class="row">
                            ...
                            <ul class="list-group list-group-flush mt-4">';
                                ...
                                for($i=0;$i<count($linkek);$i++){
                                    if ($linkek[$i] == "") {
                                        echo '<li class="list-group-item m-2">Még nincs feltöltve</li>';
                                    } else {
                            ...
                            <div class="col">
                                <div class="list-group mt-4">
                                    <a class="list-group-item" aria-current="true">
                                        ...
                                        <h5 class="mb-1">Játékaim</h5>
                                        </div>';
                                        $array = explode(",", $seged["hobby"]);

                                        if ($array[0] == "") {
                                            echo '<p class="mb-1">Még nincs feltöltve</p>';
                                        } else {
                                            echo '<p class="mb-1">'.$seged["hobby"].'</p>';
                                        }
                                    echo '</a>
                                    <a class="list-group-item" aria-current="true">
                                        <div class="d-flex w-100 justify-content-between">
                                        ...
                                        $array = explode(",", $seged["work"]);

                                        if ($array[0] == "") {
                                            echo '<p class="mb-1">Még nincs feltöltve</p>';
                                        } else {
                                            echo '<p class="mb-1">'.$seged["work"].'</p>';
                                        }
                                    echo '</a>
                                    <a class="list-group-item" aria-current="true">
                                        <div class="d-flex w-100 justify-content-between">
                                        ...
                                        $array = explode(",", $seged["sport"]);

                                        if ($array[0] == "") {
                                            echo '<p class="mb-1">Még nincs feltöltve</p>';
                                        } else {
                                            echo '<p class="mb-1">'.$seged["sport"].'</p>';
                                        }
                                    echo '</a>
                                    <a class="list-group-item" aria-current="true">
                                        <div class="d-flex w-100 justify-content-between">
                                        ...
                                        $array = explode(",", $seged["music"]);

                                        if ($array[0] == "") {
                                            echo '<p class="mb-1">Még nincs feltöltve</p>';
                                        } else {
                                            echo '<p class="mb-1">'.$seged["music"].'</p>';
                                        }
                                    echo '</a>
                                </div>
                            </div>
                            <div class="col">
                                ...
                                if ($seged["about"] == "") {
                                    echo '<p class="m-4"> Hogy csalja meg egy gamer lány a párját?
                                    <br>– R1, R2, L1 , X, Balra, Le, Jobbra, Fel, Balra, Kör, Kör, Négyzet</p>';    
                                } else {
                                    echo '<p class="m-4">'.$seged["about"].'</p>';
                                }
