                    ...
                    if ($user->num_rows > 0) {
                        while($seged = $user->fetch_assoc()) {
                            echo '<form action="../includes/edit-user.inc.php" method="POST" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group">
                                        <!--VISIBLE-->
                                        <label for="exampleInputEmail1">Látható? 0 - nem, 1 - igen</label>
                                        <input type="number" name="visible"  min="0" max="1" class="form-control" value="'.$seged["visible"].'">
                                    </div>
                                    <div class="form-group">
                                        <!--LINKEK-->
                                ...
                                echo '</div>
                                    <div class="form-group">
                                        <!--HOBBY-->
                                        <label for="exampleInputEmail1">Játékok</label>
                                        <div id="hobby"></div>';
                                        echo "<script>addInputs(".json_encode($seged['hobby']).", 'hobby', 'Játékaim...')</script>";
                                echo '</div>
                                    <div class="form-group">
                                        <!--MUNKA-->
